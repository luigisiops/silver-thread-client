    ...
    return (
        <div className='editSalesContainer'>
            ...
            <div>
                ...
                <form className={classes.root} noValidate autoComplete="off">
                    <TextField name='quantity' value={updatedSalesData.quantity} onChange={handleOnChange} id="outlined-basic" label="Quantity Sold" variant="outlined" />
                </form>
                <form className={classes.root} noValidate autoComplete="off">
                ...
                <form className={classes.root} noValidate autoComplete="off">
                    <TextField name='tax' value={updatedSalesData.tax} onChange={handleOnChange} id="outlined-basic" label="Tax" variant="outlined" />
                </form>
                <form className={classes.root} noValidate autoComplete="off">
                    <TextField name='shipping' value={updatedSalesData.shipping} onChange={handleOnChange} id="outlined-basic" label="Shipping" variant="outlined" />
                </form>               
