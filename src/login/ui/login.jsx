  ...
  return (
    <div className='login-component'>
      <div className='left-container'>
        <h2 className='blurb'>
          A Data Managment User Interface for Silver Thread Designs
        </h2>
        <h2 className='blurb'>
          Handle your business logic via linked tables and graphical interfaces
        </h2>
      </div>
      ...
      <div className='login-container'>
        ...
        <div className='login-box'>
          ...
          <div>
            Not a user? <NavLink to='/register'> Register</NavLink> and get
            permission from a moderator!
          </div>
          <div className='button-container'>
            <Button
              onClick={() => onLogin(fields)}
